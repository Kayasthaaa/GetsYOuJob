...
class __$$_NoInternetCopyWithImpl<$Res>
    extends _$LoginStateCopyWithImpl<$Res, _$_NoInternet>
...
class _$_Success implements _Success {
  const _$_Success({required this.message, required this.user});
  ...
  @override
  String toString() {
    return 'LoginState.success(message: $message, user: $user)';
  }
...
abstract class _Success implements LoginState {
  const factory _Success(
      ...
      required final UserModel user}) = _$_Success;
