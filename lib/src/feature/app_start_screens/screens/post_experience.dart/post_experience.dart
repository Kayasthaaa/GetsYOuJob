...
class PostExperienceScreenPage extends StatefulWidget {
  const PostExperienceScreenPage({Key? key}) : super(key: key);

  @override
  _PostExperienceScreenPageState createState() =>
      _PostExperienceScreenPageState();
}

class _PostExperienceScreenPageState extends State<PostExperienceScreenPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const kAppBar(title: 'Add Experience'),
      ),
